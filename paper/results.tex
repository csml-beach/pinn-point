...
Preliminary results on the Advection-Diffusion benchmark (see Fig.~\ref{fig:method-comparison}) show that while low-discrepancy sequences like Halton provide a strong baseline, our Power-Tempered and Entropy-Balanced methods demonstrate competitive convergence, particularly in the early stages of training where the residual signal is strongest.
